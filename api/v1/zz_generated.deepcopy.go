...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentCatalogInventoryEntry) DeepCopyInto(out *AgentCatalogInventoryEntry) {
	*out = *in
	...
	if in.Skills != nil {
		...
		*out = make([]AgentCatalogSkill, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentCatalogInventoryEntry.
func (in *AgentCatalogInventoryEntry) DeepCopy() *AgentCatalogInventoryEntry {
	if in == nil {
		return nil
	}
	out := new(AgentCatalogInventoryEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AgentCatalogSource) DeepCopyInto(out *AgentCatalogSource) {
	*out = *in
	...
	if in.TargetSkills != nil {
		in, out := &in.TargetSkills, &out.TargetSkills
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *AgentCatalogSpec) DeepCopyInto(out *AgentCatalogSpec) {
	*out = *in
	if in.Sources != nil {
		...
		*out = make([]AgentCatalogSource, len(*in))
		for i := range *in {
...
func (in *AgentCatalogStatus) DeepCopyInto(out *AgentCatalogStatus) {
	*out = *in
	if in.Inventory != nil {
		...
		*out = make([]AgentCatalogInventoryEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ResourceSetSpec) DeepCopyInto(out *ResourceSetSpec) {
	*out = *in
	...
	if in.Steps != nil {
		...
		*out = make([]ResourceSetStep, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
